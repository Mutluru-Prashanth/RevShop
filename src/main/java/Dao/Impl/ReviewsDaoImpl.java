...
public class ReviewsDaoImpl implements ReviewsDao {
    ...
    private static final Logger log =
            LoggerFactory.getLogger(ReviewsDaoImpl.class);
    ...
    public boolean hasPurchased(int buyerId, int productId) {
        ...
        try (Connection con = DriverManager.getConnection(
            ...
            log.error("Error checking purchase for buyer {} and product {}", buyerId, productId, e);
        }
        return false;
    }
    ...
    public boolean addReview(ReviewDTO dto) {
        ...
        try (Connection con = DriverManager.getConnection(
            ...
            log.warn("Duplicate review attempt for product {} by buyer {}",
                    dto.getProductId(), dto.getBuyerId());
    ...
    public List<ReviewDTO> getReviewsAtSeller(int sellerId) {
        ...
        try (Connection con = DriverManager.getConnection(
            ...
            log.error("Error fetching reviews for seller {}", sellerId, e);
        }
