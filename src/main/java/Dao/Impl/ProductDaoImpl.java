...
public class ProductDaoImpl implements ProductDao {
    ...
    public boolean saveProductDetails(ProductDTO productDTO) {
        ...
        String sql = "INSERT INTO product (seller_id, product_name, description, manufacturer, mrp, selling_price, stock, stock_threshold, category_id) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection con = DriverManager.getConnection(
            ...
            log.error("Error saving product details", e);
        }
        return false;
    }
...
""";
        ...
        try (Connection con = DriverManager.getConnection(
            ...
            log.error("Error fetching products for seller {}", sellerId, e);
        }
    ...
    @Override
    public boolean updateProductDetailsById(int productId, double mrp,
                                            double discountedPrice,
                                            int stock, int stockThreshold) {
        ...
        try (Connection con = DriverManager.getConnection(
            ...
            if (rows > 0) {
                ...
                log.warn("Product ID {} does not exist", productId);
...
""";
    ...
    public int getSellerIdByProductId(int productId) {
        ...
        try (Connection con = DriverManager.getConnection(
            ...
            log.error("Error fetching sellerId for product {}", productId, e);
        }
    ...
    public boolean isProductExistsForSeller(int productId, int sellerId) {
        ...
        try (Connection con = DriverManager.getConnection(
            ...
            log.error("Error checking product ownership for product {} and seller {}",
                    productId, sellerId, e);
        }
        return false;
    }
}
